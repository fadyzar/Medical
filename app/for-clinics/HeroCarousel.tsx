...
/**
 * CANNA-branded gradient hero carousel for the clinics landing page.
...
function MedicalMotif() {
  return (
    <svg className="absolute inset-0 w-full h-full" aria-hidden="true" preserveAspectRatio="xMidYMid slice">
      <defs>
        <pattern id="clinics-grid" width="64" height="64" patternUnits="userSpaceOnUse">
          <path d="M64 0H0V64" fill="none" stroke="rgba(255,255,255,0.06)" strokeWidth="1" />
        </pattern>
        <linearGradient id="clinics-ecg" x1="0" y1="0" x2="1" y2="0">
      ...
      <path
        ...
        fill="none" stroke="url(#clinics-ecg)" strokeWidth="2.5" transform="translate(0,40)"
      />
    </svg>
  )
}
