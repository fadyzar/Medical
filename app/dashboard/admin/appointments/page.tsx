...
export default function AdminAppointmentsPage() {
  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      {/* ── Header ── */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900 tracking-tight">ניהול תורים</h1>
        <p className="text-sm text-gray-500 mt-0.5">צפייה, סינון וניהול כל התורים במרפאה</p>
      </div>
      ...
      <div className="relative">
        ...
        />
        {search && (
          <button onClick={() => setSearch('')} className="absolute inset-y-0 left-3 flex items-center text-gray-400 hover:text-gray-600">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <h3 className="font-bold text-gray-900">
                ...
                {search && <span className="text-gray-400 font-normal mr-1.5 text-sm">· &quot;{search}&quot;</span>}
              </h3>
            </div>
          </CardHeader>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className={cn(
                        ...
                        'bg-gradient-to-br from-gray-100 to-gray-50 text-gray-500 border border-gray-100'
                      )}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 text-xs text-gray-500 mt-0.5 flex-wrap">
                          ...
                          {apt.doctor
                            ? <span className="font-medium text-gray-600 shrink-0">ד&quot;ר {apt.doctor.first_name} {apt.doctor.last_name}</span>
                          ...
                          {apt.patient?.phone && (
                            <><span className="text-gray-300">·</span><span className="shrink-0 font-medium">{apt.patient.phone}</span></>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="px-5 pb-5 space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                        ...
                        <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 space-y-1.5">
                          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">מטופל</p>
                          ...
                          {apt.patient?.email && <p className="text-gray-500 text-xs truncate">{apt.patient.email}</p>}
                        </div>

                        {/* Appointment */}
                        <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 space-y-1.5">
                          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">פרטי תור</p>
                          <div className="space-y-1 text-gray-700">
                            <p><span className="text-gray-400 text-xs">תלונה:</span> <span className="font-medium">{apt.chief_complaint}</span></p>
                            {apt.requested_specialty && <p><span className="text-gray-400 text-xs">התמחות:</span> {apt.requested_specialty}</p>}
                            {apt.scheduled_at && <p><span className="text-gray-400 text-xs">מועד:</span> <span className="font-medium">{formatDateTime(apt.scheduled_at)}</span></p>}
                            {apt.payment_amount && (
                              <p><span className="text-gray-400 text-xs">תשלום:</span>
                      ...
                      {apt.complaint_description && (
                        <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1.5">תיאור התלונה</p>
