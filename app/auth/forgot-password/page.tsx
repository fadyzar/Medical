    ...
    >
      ...
      <div className={cn(
        ...
        <div className="text-center py-4">
          ...
          <p className="text-teal-600 font-medium text-sm mb-6 ltr" dir="ltr">{email}</p>

          <div className="bg-teal-50 rounded-xl p-4 text-sm text-teal-700 mb-6 text-right">
            <p className="font-medium mb-1">לא קיבלת את האימייל?</p>
            <ul className="text-teal-600 space-y-1 text-xs">
