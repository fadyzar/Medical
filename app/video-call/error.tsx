    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-900 text-white" dir="rtl">
      <div className="text-center space-y-4 max-w-md px-4">
        ...
        <div className="flex gap-3 justify-center">
          <Button onClick={reset} variant="outline" className="border-slate-600 text-white hover:bg-slate-800">
            נסה שוב
          </Button>
          <Button onClick={() => window.history.back()} variant="ghost" className="text-slate-400">
            חזרה
          </Button>
        </div>
      </div>
